...
1. テーマとの関連性 (/25点)
   25-23点: 設問意図を完全に理解し、深く考察している
   22-18点: テーマを理解しているが、一部浅い
   17-13点: テーマに関連しているが、ズレがある
   12-0点: テーマとの関連性が薄い、またはズレている
...
【評価の手順】（必ず守ること）
1. まず答案全体を読み、主張文を特定する
2. 各評価項目について、ルーブリックと照らし合わせて点数を決定
3. 各項目の点数を合計してoverallScoreを算出
4. フィードバックを作成（事実ベース、具体的に）
